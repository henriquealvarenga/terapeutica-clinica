---
title: "Aula 2 — O tratamento de fundo"
subtitle: "ISRS na depressão, na ansiedade crônica e no TOC"
---
...
Os ISRS bloqueiam a **recaptação de serotonina** na fenda sináptica, aumentando a quantidade desse neurotransmissor disponível. Os principais são **fluoxetina, sertralina, escitalopram, citalopram, paroxetina e fluvoxamina**.
...
<ol class="sumario">
  <li><span class="num">01</span><a href="casos/aula2-caso1-roberto.qmd">O cansaço que não passa — Roberto, 42 anos · <em>Depressão maior</em></a></li>
  <li><span class="num">02</span><a href="casos/aula2-caso2-cleusa.qmd">A preocupação que não desliga — Dona Cleusa, 49 anos · <em>Transtorno de ansiedade generalizada</em></a></li>
  <li><span class="num">03</span><a href="casos/aula2-caso3-pedro.qmd">Quando trancar a porta não basta — Pedro, 24 anos · <em>Transtorno obsessivo-compulsivo</em></a></li>
</ol>
