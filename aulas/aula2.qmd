...
- Mecanismo, indicações e efeitos adversos dos ISRS [@statpearls_ssri].
- Trajetória de resposta dos ISRS no TOC: parte do ganho aparece cedo e doses maiores ajudam [@issari2016ocd].
- Doses supraterapêuticas de ISRS no TOC resistente [@gualtieri2025ssri].
- Critérios de episódio depressivo maior, TAG e TOC [@dsm5tr].

Procure também as diretrizes brasileiras de depressão e ansiedade (ABP) e um livro-texto de psicofarmacologia [@stahl].
